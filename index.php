	   ...
	   <!--Header starts here-->
        ...
        <div class="menubar">
            ...
            <div id="styled-button">
                <a href="admin_area/login/register.php">Not registered yet?</a>                        
                <input type="submit" class="styled-button-1" button onClick="window.location.href='admin_area/login/login.php'" value="Sign IN"/>
            </div>

        </div>
     
        <!--Navigation bar ends-->
        <div id="products_box" style="background-image: url(images/background.jpg); height: 900px; width: 1000;">
