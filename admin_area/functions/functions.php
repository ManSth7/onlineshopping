...
function getCats(){
	...
	while($row_cats=mysqli_fetch_array($run_cats)){
		...
		echo "<li><a href='all_products(login).php?cat=$cat_id'>$cat_title</a></li>";
...
function getCats2(){
	...
	while($row_cats2=mysqli_fetch_array($run_cats2)){
		...
		echo "<li><a href='all_products(login).php?cat2=$cat2_id'>$cat2_title</a></li>";
	...
	while($row_pro=mysqli_fetch_array($run_pro)){
		...
		echo"
			<div id='single_product'>
				...
				<h3>$pro_title</h3>
				<img src='product_images/$pro_image' width='200' height='175' />

				<p><b> Rs. $pro_price</b></p>

				<a href='details.php?pro_id=$pro_id' style='float:left'>Details</a>
				
				<a href='all_products(login).php?add_cart=$pro_id'><button style='float:right'>Add to Cart </button></a>
